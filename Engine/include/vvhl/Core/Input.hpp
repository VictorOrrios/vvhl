...
private:
    ...
    static void CharCallback(GLFWwindow*,
                             unsigned int codepoint);

    static void MouseButtonCallback(GLFWwindow*,
                                    int button,
                                    int action,
                                    int mods);

    static void CursorPositionCallback(GLFWwindow*,
                                       double x,
                                       double y);

    static void CursorEnterCallback(GLFWwindow*,
                                    int entered);
...
private:
    ...
    inline static std::array<ButtonState, GLFW_MOUSE_BUTTON_LAST + 1> s_mouseButtons{};
